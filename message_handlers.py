...
def parse_drink_info(text: str) -> Optional[dict]:
    ...
    patterns_with_numbers = [
        r'выпил\s+(\d+)\s*(?:г|грамм|мл|литр|л|стакан|стакана|стаканов|банка|банки|банок|бутылка|бутылки|бутылок|бутылку|бутылкой|рюмка|рюмки|рюмок|рюмку|рюмкой|пинта|пинты|пинт|бокал|бокала|бокалов|бокал|бокалом)',
        r'выпила\s+(\d+)\s*(?:г|грамм|мл|литр|л|стакан|стакана|стаканов|банка|банки|банок|бутылка|бутылки|бутылок|бутылку|бутылкой|рюмка|рюмки|рюмок|рюмку|рюмкой|пинта|пинты|пинт|бокал|бокала|бокалов|бокал|бокалом)',
        r'(\d+)\s*(?:г|грамм|мл|литр|л|стакан|стакана|стаканов|банка|банки|банок|бутылка|бутылки|бутылок|бутылку|бутылкой|рюмка|рюмки|рюмок|рюмку|рюмкой|пинта|пинты|пинт|бокал|бокала|бокалов|бокал|бокалом)\s+(?:пива|водки|вина|виски)',
        # Добавляем паттерны для сообщений с временными указаниями
        r'(?:сегодня|только что|сейчас|недавно|вчера|утром|вечером|днем|ночью)\s+(?:выпил|выпила)\s+(\d+)\s*(?:г|грамм|мл|литр|л|стакан|стакана|стаканов|банка|банки|банок|бутылка|бутылки|бутылок|бутылку|бутылкой|рюмка|рюмки|рюмок|рюмку|рюмкой|пинта|пинты|пинт|бокал|бокала|бокалов|бокал|бокалом)',
        # Добавляем паттерн для случая: выпила + временное указание + число + единица
        r'(?:выпил|выпила)\s+(?:сегодня|только что|сейчас|недавно|вчера|утром|вечером|днем|ночью)\s+(\d+)\s*(?:г|грамм|мл|литр|л|стакан|стакана|стаканов|банка|банки|банок|бутылка|бутылки|бутылок|бутылку|бутылкой|рюмка|рюмки|рюмок|рюмку|рюмкой|пинта|пинты|пинт|бокал|бокала|бокалов|бокал|бокалом)',
    ]
