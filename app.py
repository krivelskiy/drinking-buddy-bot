...
def parse_drink_info(text: str) -> Optional[dict]:
    ...
    try:
        ...
        patterns = [
            ...
            # Пиво БЕЗ числительных
            (r'выпил\s+(?:стакан|бокал|банк|бутылк|л|мл)\s*(?:пива|пивка|барнаульского)', 'пиво', 'стакан'),
            (r'(?:стакан|бокал|банк|бутылк|л|мл)\s*(?:пива|пивка|барнаульского)', 'пиво', 'стакан'),
            ...
            # Вино БЕЗ числительных
            (r'выпил\s+(?:бокал|стакан|л|мл)\s*(?:вина|винца)', 'вино', 'бокал'),
            (r'(?:бокал|стакан|л|мл)\s*(?:вина|винца)', 'вино', 'бокал'),
            ...
            # Водка БЕЗ числительных
            (r'выпил\s+(?:рюмк|стакан|л|мл)\s*(?:водки|водочки)', 'водка', 'рюмка'),
            (r'(?:рюмк|стакан|л|мл)\s*(?:водки|водочки)', 'водка', 'рюмка'),
            ...
            # Виски БЕЗ числительных
            (r'выпил\s+(?:рюмк|стакан|л|мл)\s*(?:виски|вискаря)', 'виски', 'рюмка'),
            (r'(?:рюмк|стакан|л|мл)\s*(?:виски|вискаря)', 'виски', 'рюмка'),
            ...
            # Общие БЕЗ числительных
            (r'выпил\s+(?:стакан|бокал|рюмк|л|мл)', 'напиток', 'порция'),
            (r'(?:стакан|бокал|рюмк|л|мл)', 'напиток', 'порция'),
        ]
